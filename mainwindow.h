...
private slots:
    ...
    void powerOff();
    void coldStart();
    void startTestNextROund();
    void openSerialPortRelay(QString serialPortRelay);
...
private:
    ...
    QSerialPort *serial;
    QSerialPort *serialRelay;
    QFile file;
    QTimer *timerOn;    //开机定时器
    QTimer *timerOff;    //关机定时器
